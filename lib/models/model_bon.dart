...
class model_SudahValSP {
  ...
  Future count_SudahValSP_paginate(String key_cari) async {
    ...
    final response = await Dio().post(
      "http://nurrachmadwidyanto.web.id/val_pembelian.php?count_sudah_val_sp_paginate",
      data: {"cari": key_cari},
  ...
  Future<List> data_SudahValSP_paginate(
    ...
    Dio().options.contentType = Headers.formUrlEncodedContentType;
    final response = await Dio().post(
      "http://nurrachmadwidyanto.web.id/val_pembelian.php?sudah_val_sp_paginate",
      data: {
        "cari": cari,
  ...
  Future<List> select_SudahValSP_detail(
    ...
    Dio().options.contentType = Headers.formUrlEncodedContentType;
    final response = await Dio().post(
      "http://http://nurrachmadwidyanto.web.id/val_pembelian.php?select_detail",
