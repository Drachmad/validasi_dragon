...
Widget ValPpBahanCard(BuildContext context, int index, ValPpController val_bar,
  ...
  String NAMAS = val_bar.data_ValPpList[index]['NAMAS'] ?? "-";
  String tempTTOTAL = val_bar.data_ValPpList[index]['TTOTAL'] ?? "-";
  String TTOTAL =
      NumberFormat.decimalPattern().format(double.parse(tempTTOTAL));
